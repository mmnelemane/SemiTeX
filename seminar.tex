...
%
\input{./chapters/outline_structure}
\input{./chapters/introduction}
\input{./chapters/architecture_overview}
\input{./chapters/mec_architecture}
\input{./chapters/nfv_architecture}
\input{./chapters/nfv_mec_architecture}
\input{./chapters/requirements}
\input{./chapters/enabling_technologies}
\input{./chapters/nfvi}
\input{./chapters/virtualization}
\input{./chapters/containerization}
\input{./chapters/virt_vs_containers}
\input{./chapters/opensource}
\input{./chapters/iaas_openstack}
\input{./chapters/openstack_edge}
\input{./chapters/iaas_kubernetes}
\input{./chapters/k8s_edge}
