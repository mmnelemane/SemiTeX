...
\maketitle
\addbibresource{./literature/reference.bib}
...
%
\input{./content/outline_structure}
\input{./content/introduction}
\input{./content/architecture_overview}
\input{./content/mec_architecture}
\input{./content/nfv_architecture}
\input{./content/nfv_mec_architecture}
\input{./content/requirements}
\input{./content/enabling_technologies}
\input{./content/nfvi}
\input{./content/virtualization}
\input{./content/containerization}
\input{./content/virt_vs_containers}
\input{./content/opensource}
\input{./content/iaas_openstack}
\input{./content/openstack_edge}
\input{./content/iaas_kubernetes}
\input{./content/k8s_edge}
