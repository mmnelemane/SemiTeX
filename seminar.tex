...
%
\input{\meta/Content/introduction}
\input{\meta/Content/architecture_overview}
\input{\meta/Content/mec_architecture}
\input{\meta/Content/nfv_architecture}
\input{\meta/Content/nfv_mec_architecture}
\input{\meta/Content/requirements}
\input{\meta/Content/enabling_technologies}
\input{\meta/Content/nfvi}
\input{\meta/Content/virtualization}
\input{\meta/Content/containerization}
\input{\meta/Content/virt_vs_containers}
\input{\meta/Content/iaas}
\input{\meta/Content/iaas_openstack}
\input{\meta/Content/openstack_nfv}
\input{\meta/Content/openstack_edge}
\input{\meta/Content/iaas_kubernetes}
\input{\meta/Content/k8s_edge}
\input{\meta/Content/conclusion}
%
%===============================================================================
